...
CREATE TABLE `User` (id int(10) NOT NULL AUTO_INCREMENT, pseudo varchar(255) NOT NULL, pwd varchar(255) NOT NULL, email varchar(255), isAdmin tinyint DEFAULT 0 NOT NULL, colorThemeRecipe varchar(25) DEFAULT 'grey' NOT NULL, keyAlgo varchar(255), PRIMARY KEY (id));
...
CREATE TABLE Rel_User_RecipeOrigin (idRecipeOrigin int(10) NOT NULL, idUser int(10) NOT NULL, numRankRel int(10) NOT NULL, PRIMARY KEY (idRecipeOrigin, idUser));


CREATE TABLE Expense (id int(10) NOT NULL AUTO_INCREMENT, name varchar(255) NOT NULL,  idUser int(10) NOT NULL, lastOpen tinyint DEFAULT false NOT NULL,  PRIMARY KEY (id));
CREATE TABLE ExpensePers (id int(10) NOT NULL AUTO_INCREMENT, name varchar(255) NOT NULL, idExpense int(10) NOT NULL, numColumn int(10) NOT NULL AUTO_INCREMENT, PRIMARY KEY (id));
CREATE TABLE ExpenseRow (id int(10) NOT NULL AUTO_INCREMENT, idExpense int(10) NOT NULL, idBuyer int(10) NOT NULL, amount int(10) NOT NULL, description varchar(255), numRow int(10) NOT NULL AUTO_INCREMENT, PRIMARY KEY (id));
CREATE TABLE ExpenseCase (idExpensePers int(10) NOT NULL, idExpenseRow int(10) NOT NULL, isChecked tinyint DEFAULT false NOT NULL, PRIMARY KEY (idExpensePers, idExpenseRow));

ALTER TABLE Expense ADD INDEX FKRel_Expense_S1234 (idUser), ADD CONSTRAINT FKRel_Expense_S1234 FOREIGN KEY (idUser) REFERENCES `User` (id) ON DELETE CASCADE;
ALTER TABLE ExpensePers ADD INDEX FKRel_Expense_S2345 (idExpense), ADD CONSTRAINT FKRel_Expense_S2345 FOREIGN KEY (idExpense) REFERENCES Expense (id) ON DELETE CASCADE;
ALTER TABLE ExpenseRow ADD INDEX FKRel_Expense_S3456 (idExpense), ADD CONSTRAINT FKRel_Expense_S3456 FOREIGN KEY (idExpense) REFERENCES Expense (id) ON DELETE CASCADE;
ALTER TABLE ExpenseRow ADD INDEX FKRel_Expense_S4567 (idBuyer), ADD CONSTRAINT FKRel_Expense_S4567 FOREIGN KEY (idBuyer) REFERENCES ExpensePers (id) ON DELETE CASCADE;
ALTER TABLE ExpenseCase ADD INDEX FKRel_Expense_S5678 (idExpensePers), ADD CONSTRAINT FKRel_Expense_S5678 FOREIGN KEY (idExpensePers) REFERENCES ExpensePers (id) ON DELETE CASCADE;
ALTER TABLE ExpenseCase ADD INDEX FKRel_Expense_S6789 (idExpenseRow), ADD CONSTRAINT FKRel_Expense_S6789 FOREIGN KEY (idExpenseRow) REFERENCES ExpenseRow (id) ON DELETE CASCADE;
