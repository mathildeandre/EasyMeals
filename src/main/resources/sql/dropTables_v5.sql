...
ALTER TABLE ListShopping_Category DROP FOREIGN KEY FKListShoppi989241;
...
ALTER TABLE ListShopPlanning_User DROP FOREIGN KEY FKListShopPl179177;
ALTER TABLE ListShopPlanning_User DROP FOREIGN KEY FKListShopPl355885;
ALTER TABLE ListShopPlanning_User DROP FOREIGN KEY FKListShopPl181909;
...
DROP TABLE IF EXISTS ListShopPlanning_User;
