...
myModule.controller('PlanningModalListShoppingCtrl', ['$scope', '$uibModal', '$log', function ($scope, $uibModal, $log) {
    /** ON EST ICI DS UN SCOPE FILS - on a ainsi acces aux scopes parents*/

    $scope.openModalListShopping = function (currentPlanning) {

        var modalInstance = $uibModal.open({
            animation: true,
            templateUrl: '../../partials/planning//modals/planningModalListShopping.html',
            controller: 'ModalInstanceListShoppingCtrl',
            size: 'lg',
            resolve: {
...
myModule.controller('ModalInstanceListShoppingCtrl', function ($scope, $log, $uibModalInstance, currentPlanning,  AppendixFunctionsService, restFoodService, restPlanningService) {
    /** ON EST ICI DS UN SCOPE ISOLE */


    $scope.currentPlanning = currentPlanning;
    ...
    */$scope.goShopping = function(){
    ...
    /********************************************************************************************************************
    /********************************************************************************************************************
     *  copy content from planningListShopping-controller.js
     /********************************************************************************************************************
     /********************************************************************************************************************
     /********************************************************************************************************************
     /********************************************************************************************************************
